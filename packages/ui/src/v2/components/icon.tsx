...
const icons = {
  ...
  background: {
    viewBox: "0 0 16 16",
    body: `<path d="M8 2V9" stroke="currentColor" stroke-linecap="round"/><path d="M5.5 6.5L8 9L10.5 6.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/><path d="M3 12.5H13" stroke="currentColor" stroke-linecap="round"/>`,
  },
  clock: {
    viewBox: "0 0 16 16",
