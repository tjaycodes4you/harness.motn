export const dict = {
  ...
  "ui.tool.task": "Opgave",
  "ui.tool.task.background.action": "Fortsæt i baggrunden",
  "ui.tool.task.background.label": "baggrund",
  "ui.tool.task.background.failed": "Kunne ikke flytte opgaven til baggrunden",
  "ui.tool.task.background.notice.completed": "Baggrundsopgave fuldført: {{title}}",
  "ui.tool.task.background.notice.failed": "Baggrundsopgave mislykkedes: {{title}}",
  "ui.tool.task.background.notice.cancelled": "Baggrundsopgave stoppet: {{title}}",
  "ui.tool.task.background.open": "Åbn opgave",
  "ui.tool.task.background.stop": "Stop opgave",
  "ui.tool.task.background.stop.failed": "Kunne ikke stoppe opgaven",
