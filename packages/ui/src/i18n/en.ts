export const dict: Record<string, string> = {
  ...
  "ui.sessionTurn.status.queued": "Queued",
  ...
  "ui.tool.grep": "Grep",
  "ui.tool.task": "Task",
  "ui.tool.task.background.action": "Continue in background",
  "ui.tool.task.background.label": "background",
  "ui.tool.task.background.failed": "Couldn't move the task to the background",
  "ui.tool.task.background.notice.completed": "Background task finished: {{title}}",
  "ui.tool.task.background.notice.failed": "Background task failed: {{title}}",
  "ui.tool.task.background.notice.cancelled": "Background task stopped: {{title}}",
  "ui.tool.task.background.open": "Open task",
  "ui.tool.task.background.stop": "Stop task",
  "ui.tool.task.background.stop.failed": "Couldn't stop the task",
