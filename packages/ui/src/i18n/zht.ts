...
export const dict = {
  ...
  "ui.sessionTurn.status.queued": "佇列中",
  ...
  "ui.tool.task": "任務",
  "ui.tool.task.background.action": "在背景繼續",
  "ui.tool.task.background.label": "背景",
  "ui.tool.task.background.failed": "無法將任務移至背景",
  "ui.tool.task.background.notice.completed": "背景任務已完成：{{title}}",
  "ui.tool.task.background.notice.failed": "背景任務失敗：{{title}}",
  "ui.tool.task.background.notice.cancelled": "背景任務已停止：{{title}}",
  "ui.tool.task.background.open": "開啟任務",
  "ui.tool.task.background.stop": "停止任務",
  "ui.tool.task.background.stop.failed": "無法停止任務",
  "ui.tool.skill": "技能",
