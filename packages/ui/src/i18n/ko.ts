export const dict = {
  ...
  "ui.sessionTurn.status.queued": "대기 중",
  ...
  "ui.tool.task": "작업",
  "ui.tool.task.background.action": "백그라운드에서 계속",
  "ui.tool.task.background.label": "백그라운드",
  "ui.tool.task.background.failed": "작업을 백그라운드로 이동하지 못했습니다",
  "ui.tool.task.background.notice.completed": "백그라운드 작업 완료: {{title}}",
  "ui.tool.task.background.notice.failed": "백그라운드 작업 실패: {{title}}",
  "ui.tool.task.background.notice.cancelled": "백그라운드 작업 중지됨: {{title}}",
  "ui.tool.task.background.open": "작업 열기",
  "ui.tool.task.background.stop": "작업 중지",
  "ui.tool.task.background.stop.failed": "작업을 중지하지 못했습니다",
  "ui.tool.skill": "스킬",
