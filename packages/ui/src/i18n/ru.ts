export const dict = {
  ...
  "ui.sessionTurn.status.queued": "В очереди",
  ...
  "ui.tool.task": "Задача",
  "ui.tool.task.background.action": "Продолжить в фоне",
  "ui.tool.task.background.label": "фон",
  "ui.tool.task.background.failed": "Не удалось перевести задачу в фон",
  "ui.tool.task.background.notice.completed": "Фоновая задача завершена: {{title}}",
  "ui.tool.task.background.notice.failed": "Фоновая задача не выполнена: {{title}}",
  "ui.tool.task.background.notice.cancelled": "Фоновая задача остановлена: {{title}}",
  "ui.tool.task.background.open": "Открыть задачу",
  "ui.tool.task.background.stop": "Остановить задачу",
  "ui.tool.task.background.stop.failed": "Не удалось остановить задачу",
  "ui.tool.skill": "Навык",
