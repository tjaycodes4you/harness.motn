...
export const dict = {
  ...
  "ui.sessionTurn.status.queued": "In Warteschlange",
  ...
  "ui.tool.task.background.action": "Im Hintergrund fortsetzen",
  "ui.tool.task.background.label": "Hintergrund",
  "ui.tool.task.background.failed": "Aufgabe konnte nicht in den Hintergrund verschoben werden",
  "ui.tool.task.background.notice.completed": "Hintergrundaufgabe abgeschlossen: {{title}}",
  "ui.tool.task.background.notice.failed": "Hintergrundaufgabe fehlgeschlagen: {{title}}",
  "ui.tool.task.background.notice.cancelled": "Hintergrundaufgabe gestoppt: {{title}}",
  "ui.tool.task.background.open": "Aufgabe öffnen",
  "ui.tool.task.background.stop": "Aufgabe stoppen",
  "ui.tool.task.background.stop.failed": "Aufgabe konnte nicht gestoppt werden",
