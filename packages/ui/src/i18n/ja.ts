export const dict = {
  ...
  "ui.tool.task": "タスク",
  "ui.tool.task.background.action": "バックグラウンドで続行",
  "ui.tool.task.background.label": "バックグラウンド",
  "ui.tool.task.background.failed": "タスクをバックグラウンドに移動できませんでした",
  "ui.tool.task.background.notice.completed": "バックグラウンドタスクが完了しました: {{title}}",
  "ui.tool.task.background.notice.failed": "バックグラウンドタスクが失敗しました: {{title}}",
  "ui.tool.task.background.notice.cancelled": "バックグラウンドタスクを停止しました: {{title}}",
  "ui.tool.task.background.open": "タスクを開く",
  "ui.tool.task.background.stop": "タスクを停止",
  "ui.tool.task.background.stop.failed": "タスクを停止できませんでした",
  "ui.tool.skill": "スキル",
