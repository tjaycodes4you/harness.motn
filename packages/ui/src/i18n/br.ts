export const dict = {
  ...
  "ui.sessionTurn.status.queued": "Na fila",
  ...
  "ui.tool.task": "Tarefa",
  "ui.tool.task.background.action": "Continuar em segundo plano",
  "ui.tool.task.background.label": "segundo plano",
  "ui.tool.task.background.failed": "Não foi possível mover a tarefa para segundo plano",
  "ui.tool.task.background.notice.completed": "Tarefa em segundo plano concluída: {{title}}",
  "ui.tool.task.background.notice.failed": "Falha na tarefa em segundo plano: {{title}}",
  "ui.tool.task.background.notice.cancelled": "Tarefa em segundo plano interrompida: {{title}}",
  "ui.tool.task.background.open": "Abrir tarefa",
  "ui.tool.task.background.stop": "Parar tarefa",
  "ui.tool.task.background.stop.failed": "Não foi possível parar a tarefa",
