export const dict = {
  ...
  "ui.sessionTurn.status.queued": "في الانتظار",
  ...
  "ui.tool.task": "مهمة",
  "ui.tool.task.background.action": "المتابعة في الخلفية",
  "ui.tool.task.background.label": "الخلفية",
  "ui.tool.task.background.failed": "تعذّر نقل المهمة إلى الخلفية",
  "ui.tool.task.background.notice.completed": "اكتملت المهمة في الخلفية: {{title}}",
  "ui.tool.task.background.notice.failed": "فشلت المهمة في الخلفية: {{title}}",
  "ui.tool.task.background.notice.cancelled": "أُوقفت المهمة في الخلفية: {{title}}",
  "ui.tool.task.background.open": "فتح المهمة",
  "ui.tool.task.background.stop": "إيقاف المهمة",
  "ui.tool.task.background.stop.failed": "تعذّر إيقاف المهمة",
  "ui.tool.skill": "مهارة",
