export const dict: Record<string, string> = {
  ...
  "ui.sessionTurn.status.queued": "У черзі",
  ...
  "ui.tool.task.background.action": "Продовжити у фоновому режимі",
  "ui.tool.task.background.label": "фон",
  "ui.tool.task.background.failed": "Не вдалося перевести завдання у фон",
  "ui.tool.task.background.notice.completed": "Фонове завдання завершено: {{title}}",
  "ui.tool.task.background.notice.failed": "Фонове завдання не виконано: {{title}}",
  "ui.tool.task.background.notice.cancelled": "Фонове завдання зупинено: {{title}}",
  "ui.tool.task.background.open": "Відкрити завдання",
  "ui.tool.task.background.stop": "Зупинити завдання",
  "ui.tool.task.background.stop.failed": "Не вдалося зупинити завдання",
