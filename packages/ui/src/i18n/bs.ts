...
export const dict = {
  ...
  "ui.sessionTurn.status.queued": "U redu",
  ...
  "ui.tool.task.background.action": "Nastavi u pozadini",
  "ui.tool.task.background.label": "pozadina",
  "ui.tool.task.background.failed": "Nije moguće premjestiti zadatak u pozadinu",
  "ui.tool.task.background.notice.completed": "Zadatak u pozadini završen: {{title}}",
  "ui.tool.task.background.notice.failed": "Zadatak u pozadini nije uspio: {{title}}",
  "ui.tool.task.background.notice.cancelled": "Zadatak u pozadini zaustavljen: {{title}}",
  "ui.tool.task.background.open": "Otvori zadatak",
  "ui.tool.task.background.stop": "Zaustavi zadatak",
  "ui.tool.task.background.stop.failed": "Nije moguće zaustaviti zadatak",
