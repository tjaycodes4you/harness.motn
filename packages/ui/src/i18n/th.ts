export const dict = {
  ...
  "ui.sessionTurn.status.queued": "อยู่ในคิว",
  ...
  "ui.tool.task": "งาน",
  "ui.tool.task.background.action": "ดำเนินการต่อในเบื้องหลัง",
  "ui.tool.task.background.label": "เบื้องหลัง",
  "ui.tool.task.background.failed": "ไม่สามารถย้ายงานไปยังเบื้องหลังได้",
  "ui.tool.task.background.notice.completed": "งานเบื้องหลังเสร็จสิ้น: {{title}}",
  "ui.tool.task.background.notice.failed": "งานเบื้องหลังล้มเหลว: {{title}}",
  "ui.tool.task.background.notice.cancelled": "งานเบื้องหลังถูกหยุด: {{title}}",
  "ui.tool.task.background.open": "เปิดงาน",
  "ui.tool.task.background.stop": "หยุดงาน",
  "ui.tool.task.background.stop.failed": "ไม่สามารถหยุดงานได้",
  "ui.tool.skill": "ทักษะ",
