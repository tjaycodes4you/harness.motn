...
export const dict = {
  ...
  "ui.sessionTurn.status.queued": "排队中",
  ...
  "ui.tool.task": "任务",
  "ui.tool.task.background.action": "在后台继续",
  "ui.tool.task.background.label": "后台",
  "ui.tool.task.background.failed": "无法将任务移到后台",
  "ui.tool.task.background.notice.completed": "后台任务已完成：{{title}}",
  "ui.tool.task.background.notice.failed": "后台任务失败：{{title}}",
  "ui.tool.task.background.notice.cancelled": "后台任务已停止：{{title}}",
  "ui.tool.task.background.open": "打开任务",
  "ui.tool.task.background.stop": "停止任务",
  "ui.tool.task.background.stop.failed": "无法停止任务",
  "ui.tool.skill": "技能",
