export const dict = {
  ...
  "ui.sessionTurn.status.queued": "En cola",
  ...
  "ui.tool.task": "Tarea",
  "ui.tool.task.background.action": "Continuar en segundo plano",
  "ui.tool.task.background.label": "segundo plano",
  "ui.tool.task.background.failed": "No se pudo mover la tarea a segundo plano",
  "ui.tool.task.background.notice.completed": "Tarea en segundo plano finalizada: {{title}}",
  "ui.tool.task.background.notice.failed": "Tarea en segundo plano fallida: {{title}}",
  "ui.tool.task.background.notice.cancelled": "Tarea en segundo plano detenida: {{title}}",
  "ui.tool.task.background.open": "Abrir tarea",
  "ui.tool.task.background.stop": "Detener tarea",
  "ui.tool.task.background.stop.failed": "No se pudo detener la tarea",
