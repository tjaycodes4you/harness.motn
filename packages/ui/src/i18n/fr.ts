export const dict = {
  ...
  "ui.sessionTurn.status.queued": "En file d'attente",
  ...
  "ui.tool.task": "Tâche",
  "ui.tool.task.background.action": "Continuer en arrière-plan",
  "ui.tool.task.background.label": "arrière-plan",
  "ui.tool.task.background.failed": "Impossible de passer la tâche en arrière-plan",
  "ui.tool.task.background.notice.completed": "Tâche en arrière-plan terminée : {{title}}",
  "ui.tool.task.background.notice.failed": "Tâche en arrière-plan échouée : {{title}}",
  "ui.tool.task.background.notice.cancelled": "Tâche en arrière-plan arrêtée : {{title}}",
  "ui.tool.task.background.open": "Ouvrir la tâche",
  "ui.tool.task.background.stop": "Arrêter la tâche",
  "ui.tool.task.background.stop.failed": "Impossible d'arrêter la tâche",
