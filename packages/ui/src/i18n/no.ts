...
export const dict: Record<Keys, string> = {
  ...
  "ui.sessionTurn.status.queued": "I kø",
  ...
  "ui.tool.task.background.action": "Fortsett i bakgrunnen",
  "ui.tool.task.background.label": "bakgrunn",
  "ui.tool.task.background.failed": "Kunne ikke flytte oppgaven til bakgrunnen",
  "ui.tool.task.background.notice.completed": "Bakgrunnsoppgave fullført: {{title}}",
  "ui.tool.task.background.notice.failed": "Bakgrunnsoppgave mislyktes: {{title}}",
  "ui.tool.task.background.notice.cancelled": "Bakgrunnsoppgave stoppet: {{title}}",
  "ui.tool.task.background.open": "Åpne oppgave",
  "ui.tool.task.background.stop": "Stopp oppgave",
  "ui.tool.task.background.stop.failed": "Kunne ikke stoppe oppgaven",
