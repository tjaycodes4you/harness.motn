...
export const dict = {
  ...
  "ui.sessionTurn.status.queued": "Sırada",
  ...
  "ui.tool.task": "Görev",
  "ui.tool.task.background.action": "Arka planda devam et",
  "ui.tool.task.background.label": "arka plan",
  "ui.tool.task.background.failed": "Görev arka plana taşınamadı",
  "ui.tool.task.background.notice.completed": "Arka plan görevi tamamlandı: {{title}}",
  "ui.tool.task.background.notice.failed": "Arka plan görevi başarısız: {{title}}",
  "ui.tool.task.background.notice.cancelled": "Arka plan görevi durduruldu: {{title}}",
  "ui.tool.task.background.open": "Görevi aç",
  "ui.tool.task.background.stop": "Görevi durdur",
  "ui.tool.task.background.stop.failed": "Görev durdurulamadı",
