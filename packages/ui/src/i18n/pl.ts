export const dict = {
  ...
  "ui.sessionTurn.status.queued": "W kolejce",
  ...
  "ui.tool.task.background.action": "Kontynuuj w tle",
  "ui.tool.task.background.label": "tło",
  "ui.tool.task.background.failed": "Nie udało się przenieść zadania do tła",
  "ui.tool.task.background.notice.completed": "Zadanie w tle ukończone: {{title}}",
  "ui.tool.task.background.notice.failed": "Zadanie w tle nie powiodło się: {{title}}",
  "ui.tool.task.background.notice.cancelled": "Zadanie w tle zatrzymane: {{title}}",
  "ui.tool.task.background.open": "Otwórz zadanie",
  "ui.tool.task.background.stop": "Zatrzymaj zadanie",
  "ui.tool.task.background.stop.failed": "Nie udało się zatrzymać zadania",
