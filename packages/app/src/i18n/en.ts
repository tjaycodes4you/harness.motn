export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by motn",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in motn.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "motn Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in motn.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in motn.",
  ...
  "dialog.server.description": "Switch which motn server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "motn",
  ...
  "wsl.onboarding.checkingOpencode": "Checking motn...",
  "wsl.onboarding.checkingOpencodeIn": "Checking motn in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating motn...",
  "wsl.onboarding.updatingOpencodeIn": "Updating motn in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update motn in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update motn",
  "wsl.onboarding.opencodeReadyIn": "motn is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "motn is ready.",
  "wsl.onboarding.installOpencodeIn": "Install motn in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install motn",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "motn not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before motn can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "motn could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen motn.",
  ...
  "toast.update.description": "A new version of motn ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the motn team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, motn does not support MCP authentication yet.',
  ...
  "dialog.newProject.path": "Project folder path",
  ...
  "sidebar.gettingStarted.line1": "motn includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the motn server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for motn",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how motn looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether motn follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how motn is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when motn launches",
  ...
  "settings.data.push.title": "Push to opencode",
  "settings.data.push.description": "Copy sessions created in the harness into the plain opencode install",
  "settings.data.push.button": "Push now",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of motn.",
